...
leaflet() %>% 
  ...
  addLayersControl(                                 # we are adding layers control to the maps
    baseGroups = c("Geo","Aerial", "Physical"),
    options = layersControlOptions(collapsed = F)) # checking I am in the right area
...
# apply the know-how to YOUR 1_dk object. 
...
# The clustering needs to happen in the process of adding markers 
...
# The unclustered map shows a much more detailed layout of points across the map, whereas with clustering, the view becomes more easily digestible, if looking at a high density or large area map.
